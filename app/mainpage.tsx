...
export default function MainPage() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-backgroundColor">
      <View className="absolute top-0 left-0 right-0 bg-[#020528] flex-row justify-between items-center px-5 py-6 z-10">
      ...
      <StatusBar backgroundColor="#020528" />
    </SafeAreaView>
  );
}
